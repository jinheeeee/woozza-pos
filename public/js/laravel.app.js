...
window.hangul = __webpack_require__(42);
...
$('.keyboard').on('mousedown', function (e) {
  var toggleSpecial = function toggleSpecial() {
  ...
  var toggleShift = function toggleShift() {
    var set_shift = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  ...
  var toggleLanguage = function toggleLanguage() {
    var set_language = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  ...
  if (func = $(e.target).data('func')) {
    if (func == 'close') {
      ...
      var start = $(':focus').prop('selectionStart');
      ...
      var _start = $(':focus').prop('selectionStart');
      $(':focus').val($(':focus').val().substr(0, _start) + ' ' + $(':focus').val().substr(_start, $(':focus').val().length - _start));
      $(':focus').prop('selectionStart', _start + 1);
      $(':focus').prop('selectionEnd', _start + 1);
    } else if (func == 'language') {
      toggleLanguage();
    } else if (func == 'left') {
      var _start2 = $(':focus').prop('selectionStart');
      $(':focus').prop('selectionStart', _start2 - 1);
      $(':focus').prop('selectionEnd', _start2 - 1);
    } else if (func == 'right') {
      var _start3 = $(':focus').prop('selectionStart');
      if (_start3 == $(':focus').val().length) {
        _start3 = -1;
      }
      $(':focus').prop('selectionStart', _start3 + 1);
      $(':focus').prop('selectionEnd', _start3 + 1);
    } else {
      alert('?');
    }
  } else {
